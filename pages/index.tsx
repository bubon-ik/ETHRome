...
export default function Home() {
    ...
    }, [ensAvatar]);  // Hardcoded fallback for the specific address we know has an ENS name on Sepolia
                                    ...
                                    {tabs.map((tab) => {
                                        ...
                                        return (
                                            <motion.button
                                                ...
                                                className={`nav-tab-button flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-medium transition-all duration-300 flex-1 min-w-0 ${activeTab === tab.id
                                    ...
                                    {tabs.map((tab) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`nav-tab-button flex flex-col items-center gap-1 sm:gap-2 px-2 sm:px-3 py-3 sm:py-4 rounded-xl font-medium transition-all text-center text-xs sm:text-sm ${activeTab === tab.id
                                                        ? 'liquid-glass-button text-white shadow-glass'
                                ...
                                <div className="flex justify-center">
                                    <div className="liquid-glass rounded-2xl p-1 flex">
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl font-medium transition-all ${swapMode === 'simple'
                                                    ? 'liquid-glass-button'
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl font-medium transition-all ${swapMode === 'fusion'
                                                    ? 'liquid-glass-button'
                                                    : 'text-white/70 hover:text-white hover:bg-glass-white-5'
                                                }`}
                                        >
